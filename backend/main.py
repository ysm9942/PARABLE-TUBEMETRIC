...
from routers import youtube, instagram, tiktok, live, scraper_queue  # noqa: E402
...
app.include_router(scraper_queue.router, prefix="/api/scraper", tags=["Scraper Queue"])
